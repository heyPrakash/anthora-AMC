      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-card rounded-2xl shadow-lg p-8 space-y-8">
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">To exercise these rights, contact us at <a href="mailto:remindisupport@gamil.com" className="text-primary hover:underline">remindisupport@gamil.com</a></p>
          </section>
